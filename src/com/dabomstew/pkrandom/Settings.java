...
public class Settings {
    ...
    public String toString() {
        ...
        // 42 (Legacy Double Battle Mode), Additional Boss/Important Trainer Pokemon,
        // Weigh Duplicate Abilities
        out.write((0) |
                (additionalBossTrainerPokemon << 1) |
                (additionalImportantTrainerPokemon << 4) |
                (weighDuplicateAbilitiesTogether ? 0x80 : 0));

        // 43 Additional Regular Trainer Pokemon, Aura modification, evolution moves,
        // guarantee X items
        ...
        // 50 trainer pokemon held items / pokemon ensure two abilities / trainers use
        // local pokemon
        ...
        // 57 evolutions 2
        out.write(makeByteSelected(evosForceGrowth, evosNoConvergence, changeNamesToTypes));
    ...
    public static Settings fromString(String settingsString)
        ...
        // restoreState(data[42], 0)) Legacy setting. This bit used to be used for
        // "Double Battle Only Mode"
        ...
        settings.setChangeNamesToTypes(restoreState(data[57], 2));
    ...
    public boolean isChangeNamesToTypes() {
        return changeNamesToTypes;
    }

    public void setChangeNamesToTypes(boolean changeNamesToTypes) {
        this.changeNamesToTypes = changeNamesToTypes;
    }
