...
public class Gen4EditorFrame extends JFrame {
    ...
    // Move-tutor compatibility matrix (generation-agnostic panel, reused from the Gen5 editor). Null
    // for Diamond/Pearl, which have no move tutors; only Platinum and HG/SS show the tab.
    ...
    private void initializeUI() {
        ...
        // Move Tutors (Platinum / HeartGold-SoulSilver only)
