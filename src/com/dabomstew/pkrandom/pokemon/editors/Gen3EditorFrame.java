...
public class Gen3EditorFrame extends JFrame {
    ...
    // Move-tutor compatibility matrix. The panel is generation-agnostic (it works purely off the
    // RomHandler interface), so the Gen5+ implementation is reused. Stays null for Ruby/Sapphire,
    // which have no move tutors; only Emerald and FireRed/LeafGreen show the tab.
    ...
    private void initializeUI() {
        ...
        // Move Tutors (Emerald / FireRed-LeafGreen only)
